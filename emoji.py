...
emoji_dist={0:cur_path+"/data/emojis/angry.png",1:cur_path+"/data/emojis/disgust.png",2:cur_path+"/data/emojis/fear",3:cur_path+"/data/emojis/happy.png",4:cur_path+"/data/emojis/neutral.png",5:cur_path+"/data/emojis/sad.png",6:cur_path+"/data/emojis/surprise.png"}
...
if __name__ == '__main__':
    ...
    root['bg']='black'
    exitButton = Button(root,text='close',fg="red",command=root.destroy,font=('arial',32,'bold')).pack(side=BOTTOM)
